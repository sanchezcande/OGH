...
export const TimelineLine = styled.div`
  ...
  bottom: 0;
  width: 1px;
  background-image: linear-gradient(to bottom, grey 70%, transparent 30%);
...
export const TimelineDot = styled.div`
  ...
  transform: translateX(
    -50%
  ); // Keep horizontally centered but let parent handle visibility
...
export const TimelineContent = styled.div`
  ...
  h3 {
    ...
    * {
      color: ${({ theme }) =>
        theme.colors
          .text} !important; // Force same color for all child elements
    }
