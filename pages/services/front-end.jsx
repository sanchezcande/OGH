...
import { FaCode, FaMobileAlt, FaDesktop, FaRocket, FaPalette, FaCogs, FaUsers, FaCheckCircle, FaArrowRight, FaLaptopCode, FaTabletAlt, FaMobile } from "react-icons/fa";
  ...
  return (
    <>
        ...
        <div style={{ 
          ...
          <div className="animate" style={{ animationDelay: "0.1s" }}>
            <div style={{ 
              ...
              <span style={{ fontSize: "0.9rem", fontWeight: 500, color: "#F97B72" }}>Frontend Development</span>
            </div>
            ...
            <h1 style={{ 
              ...
              {lang === "es" ? "Construimos experiencias digitales que cautivan" : "We build digital experiences that captivate"}
            </h1>
          ...
          <div className="animate" style={{ animationDelay: "0.3s", textAlign: "center" }}>
            <div style={{ 
              position: "relative",
      ...
      <section style={{ 
        ...
        <div className="animate" style={{ maxWidth: 800, margin: "0 auto", marginBottom: "3rem" }}>
          <h2 style={{ 
            fontSize: "2.5rem", 
            fontWeight: 700, 
            marginBottom: "16px",
        ...
        <div style={{ 
          ...
          {technologies.map((tech, index) => (
            <div key={tech.name} className="animate tech-badge" style={{
              background: "white",
              padding: "1.5rem 2rem",
              borderRadius: "16px",
      ...
      <section style={{ 
        ...
        <div className="animate" style={{ maxWidth: 800, margin: "0 auto", marginBottom: "4rem" }}>
          <h2 style={{ 
            fontSize: "2.5rem", 
            fontWeight: 700, 
            marginBottom: "16px",
            ...
            {lang === "es" ? "Diseño responsivo perfecto" : "Perfect responsive design"}
          </h2>
          <p style={{ 
            fontSize: "1.1rem", 
            color: "#64748b",
        ...
        <div style={{ 
          ...
          {devices.map((device, index) => (
            <div key={device.name} className="animate device-card" style={{
              background: "linear-gradient(135deg, #4a5568 0%, #2d3748 100%)",
              color: "white",
              padding: "2.5rem 2rem",
              borderRadius: "20px",
            ...
            {[
              {
                ...
                description: lang === "es" ? "Creamos wireframes y prototipos visuales" : "We create wireframes and visual prototypes"
              },
              {
                icon: <FaCode />,
                title: lang === "es" ? "Desarrollo" : "Development",
                description: lang === "es" ? "Codificamos con las mejores prácticas" : "We code with best practices"
              },
              {
                icon: <FaCogs />,
                title: lang === "es" ? "Optimización" : "Optimization",
                description: lang === "es" ? "Mejoramos performance y accesibilidad" : "We improve performance and accessibility"
              },
              {
                icon: <FaRocket />,
                title: lang === "es" ? "Lanzamiento" : "Launch",
                description: lang === "es" ? "Desplegamos y monitoreamos" : "We deploy and monitor"
              }
            ].map((step, index) => (
              <div key={step.title} className="animate" style={{
                background: "white",
                padding: "2.5rem 2rem",
                borderRadius: "20px",
                textAlign: "center",
