  ...
  const services = [
    {
      ...
      desc:
        lang === "es"
          ? "Identidad visual completa y memorable"
          : "Complete and memorable visual identity",
    },
    {
      icon: <FaImage />,
      ...
      desc:
        lang === "es"
          ? "Gráficos para web, apps y redes sociales"
          : "Graphics for web, apps and social media",
    },
    {
      icon: <FaPenNib />,
      ...
      desc:
        lang === "es"
          ? "Ilustraciones únicas y personalizadas"
          : "Unique and personalized illustrations",
    },
    {
      icon: <FaLayerGroup />,
      ...
      desc:
        lang === "es"
          ? "Folletos, tarjetas y material promocional"
          : "Brochures, cards and promotional material",
    },
  ];
  ...
  const process = [
    {
      ...
      desc:
        lang === "es"
          ? "Entendemos tu marca y objetivos"
          : "We understand your brand and goals",
    },
    {
      icon: <FaPalette />,
      ...
      desc:
        lang === "es"
          ? "Desarrollamos conceptos creativos"
    ...
    },
    {
      ...
      desc:
        lang === "es"
          ? "Diseñamos con pasión y precisión"
              ...
              <React.Fragment key={step.title}>
                ...
                {index < process.length - 1 &&
                  (isMobile ? (
                    ...
                    >
                      <FaArrowDown
                        style={{ fontSize: "1.5rem", color: "#F97B72" }}
                      />
                    </div>
                  ) : (
                    <div
      ...
      >
        ...
        >
          {colors.map((color, index) => (
            <div
              key={color.name}
              className="animate color-palette"
              style={{
                width: 80,
                height: 80,
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          >
            ...
            <CallToActionBlock
              title={
                lang === "es"
                  ? "¡Diseñemos algo que destaque!"
                  : "Let's design something that stands out!"
              }
              description={
                lang === "es"
                  ? "Descubrí cómo podemos transformar tu idea en un diseño increíble."
                  : "Discover how we can transform your idea into an amazing design."
              }
              buttonText={
